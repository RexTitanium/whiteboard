...
interface HomeProps {
    ...
    setBoards: React.Dispatch<React.SetStateAction<Record<string, string>>>;
  ...
  return (
    <div className="p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {Object.entries(boards).map(([name, dataUrl]) => (
            <div
                key={name}
                className="w-72 bg-white border rounded-lg shadow hover:shadow-md transition"
            >
                <div
